                    ...
                    <div id="button_wrapper">
                        <div class="row">
                            <div class="col-md-6 d-flex my-1">
                                <a href="{{route('products.create')}}" class="btn btn-success btn-sm me-1">Thêm</a>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                        <table class="table table-hover" id="products">
                            <thead>
                            <tr>
                                <th><a href="#" class="dataTable-sorter">id</a>
                                </th>
                                <th><a href="#" class="dataTable-sorter">tên sản phẩm</a>
                                </th>
                                <th><a href="#" class="dataTable-sorter">giá</a>
                                </th>
                                <th>
                                    sửa
                                </th>
                    ...
                    {data: 'show', name: 'show', orderable: false, searchable: false},
                    {
                        ...
                        render: function (data,type,row,meta){
                            return `<form action='${data}' method='post'>
                                        @csrf
                                        <button type='button' class='delete btn btn-danger btn-sm' >xóa</button>
                                    </form>`
                        }
                    },
                ],
