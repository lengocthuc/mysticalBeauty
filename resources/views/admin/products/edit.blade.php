                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="last-name-column" class="form-control"
                                               placeholder="Giá" name="price" value="{{$product->price}}">
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label>Danh mục</label>
                                        <select name="categories[]" multiple="multiple" class="form-control" id="multipleSelect">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="tab-content mt-3" id="nav-tabContent">
                                        @foreach($details as $key => $detail)
                                        <div class="tab-pane {{$key==0?'show active':''}}" id="detail-{{$key}}" role="tabpanel"
                                             aria-labelledby="nav-home-tab">
                                            <div class="row">
                                                <div class="col-md-3 col-lg-6">
                                                    <div class="form-group">
                                                        <label>màu sắc</label>
                                                        <input class="form-control" type="color" name="color" value="{{$detail->color}}"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-lg-6">
                                                    <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            @foreach($categories as $category)
                var $newOption = $("<option selected='selected'></option>").val("{{$category->id}}").text('{{$category->name}}')

                $("#multipleSelect").append($newOption);
            @endforeach
